...
export default function HeapSortVisualizer({
  ...
  const getBarColor = (index: number, value: number) => {
    if (sortedPortion.includes(index)) return "#10b981";
    if (currentNode === index) return "#ef4444";
    if (comparingNodes.includes(index)) return "#f59e0b";
    if (heapSize !== null && index >= heapSize) return "#6b7280";
  ...
  return (
    <div className="flex flex-col items-center gap-6 p-6 w-full max-w-7xl mx-auto bg-gradient-to-br from-slate-50 to-purple-50 rounded-2xl shadow-xl">
      <div className="text-center">
        <h2 className="text-4xl font-bold text-slate-800 mb-2 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
          HeapSort Visualizer
        </h2>
        <p className="text-slate-600">Watch the heap property in action!</p>
      </div>
                ...
                <div
                  className={`rounded-lg flex items-end justify-center text-white font-bold shadow-lg transform transition-all duration-300 border-2 ${
                    isActive
                      ...
                      : isComparing
                      ? "ring-4 ring-yellow-400 scale-105 border-yellow-300"
                      : isSorted
        ...
        <button
          ...
          className={`px-8 py-3 text-lg rounded-xl font-semibold transition-all duration-200 transform ${
            isSorting
              ...
              : "bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 hover:scale-105 active:scale-95 shadow-lg"
          } text-white`}
        >
      ...
      <div className="bg-white rounded-lg p-4 shadow-md max-w-4xl">
        <h3 className="font-bold text-slate-800 mb-2">How HeapSort Works:</h3>
